// Pre-generate Space Quest's voice clips via ElevenLabs into
// examples/space-preview/public/voice/<voice>/*.mp3
//   node packages/space/scripts/gen-voice.mjs [--force] [--voice Jessica]
...
// repo root = 3 levels up from packages/space/scripts/
const repoRoot = path.resolve(__dirname, '../../..');

const courseFile = path.join(repoRoot, 'packages/space/space.course.yml');
...
console.log(`voice: ${voice.name} (${voice.voice_id}) → examples/space-preview/public/voice/${slug}/`);

const outDir = path.join(repoRoot, 'examples/space-preview/public/voice', slug);
...
console.log(`done — ${made} generated, ${skipped} already present in examples/space-preview/public/voice/${slug}/`);
